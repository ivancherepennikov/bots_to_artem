...
def parse_buttons(message: types.Message):
    ...
    if message.text == "фотографии/отзывы":
        ...
        markup.add(types.KeyboardButton("назад"))
        text = """
        <b>1. Нужны ли права на ваши электровелосипеды?</b><br>
        Нет, все электровелосипеды по документам 240 Ватт.<br><br>
        <b>2. Есть ли у Вас залог?</b><br>
        Нет, аренда осуществляется по договору.<br><br>
        <b>3. Должен ли я платить, если электровелосипед сломается?</b><br>
        Повреждения по типу износа колодок, износа резины оплачиваются за наш счёт;<br>
        В случае, если повреждения на велосипеде по вашей вине (разбито зеркало заднего вида, например),<br>
        то они оплачиваются в соответствии с приложением «штрафы» к договору.<br><br>
        <b>4. Есть ли скидки постоянным клиентам?</b><br>
        Да, с третьей аренды предоставляется скидка.<br><br>
        <b>5. Сколько аккумуляторов я могу взять?</b><br>
        Количество не ограничено, хоть 1, хоть 5.<br><br>
        Если у вас ещё остались вопросы, пишите нашим менеджерам <a href="https://t.me/temaLiberty">Артем</a> и <a href="https://t.me/egoorst">Егор</a>.
        """
