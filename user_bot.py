...
def parse_buttons(message: types.Message):
    ...
    if message.text == "фотографии/отзывы":
        ...
        text = (
            ...
            "Повреждения по типу износа колодок, износа резины оплачиваются за наш счёт\\;\n"
            "В случае, если повреждения на велосипеде по вашей вине \\(разбито зеркало заднего вида, например\\),\n"
            "то они оплачиваются в соответствии с приложением «штрафы» к договору\\.\n\n"
            ...
            "Если у вас ещё остались вопросы, пишите нашим менеджерам [Артем](https://t.me/temaLiberty) и [Егор](https://t.me/egoorst)"
        )
